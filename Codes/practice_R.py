...
# Set up GPIO for servo motor control
    servo_pin = 12  # Change this to the GPIO pin connected to your servo
...
def parse_opt():
    ...
    parser.add_argument("--source", type=str, default=0, help="source of input stream (0 for webcam or path to video file)")
